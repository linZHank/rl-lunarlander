...
return_dir_list = [
    ...
    sys.path[0] + '/models/ac/LunarLanderContinuous-v2',
...
names = ['dqn', 'actor-critic', 'ddpg', 'ppo', 'ppo_entropy', 'sac', 'sac_fixed_entropy', 'sac_auto_entropy']
colors = ['limegreen', 'gold', 'grey', 'deeppink', 'violet', 'royalblue', 'dodgerblue', 'deepskyblue']
