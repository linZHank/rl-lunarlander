...
# Create Squashed Gaussian Actor Network
class SquashedGaussianMLPActor(tf.Module):
    def __init__(self, dim_obs, dim_acts, activation, act_limit, name=None):
    super(SquashedGaussianMLPActor, self).__init__(name=name)
    ...
    self.mu_layer = tf.keras.layers.Dense(64, )
